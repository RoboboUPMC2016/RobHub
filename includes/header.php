<header id="fh5co-header" role="banner">
  <div class="container">
    <div class="header-inner">
      <h1><img src="assets/images/robhub.svg" id="logo-robhub" alt="robhub logo"><a href="index.php">RobHub</a></h1>
        <nav role="navigation">
          <ul>
          <?php
            //echo '<li><a ' . ($title === $TITLE_HOME ? ' class="active" ' : ' ') . ' href="index.php">' . $TITLE_HOME . '</a></li>';
            echo '<li><a ' . ($title === $TITLE_HOME ? ' class="active" ' : ' ') . ' href="index2.php">' . $TITLE_HOME . ' 2 </a></li>';
